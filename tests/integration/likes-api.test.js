 ...
 * 
 * Tests for likes feature API endpoints using real Supabase database
 * Uses TestTransaction for automatic cleanup after each test
 */
...
describe('Likes API Integration Tests', () => {
  beforeEach(async () => {
    ...
    testItem2 = await transaction.createTestItem(testUser2.id, {
      name: 'Test Jeans',
      category: 'bottom',
      is_public: true
    })
