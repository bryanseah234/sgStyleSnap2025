      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div className="lg:col-span-1 order-2 lg:order-1">
          {selectedOwner === "me" ? (
                  ...
                  <div className={`text-center py-12 rounded-2xl ${
                    ...
                    <p className={`text-sm ${
                      ...
                      {activeCategory === "all" 
                        ...
                        : `No ${activeCategory} found in your cabinet`}
                    </p>
                  </div>
                ) : (
                  <div className="grid grid-cols-2 gap-3">
                    {filteredItems.map((item) => (
                      ...
                      >
                        <ClothingItemCard 
                          item={item} 
                          onDelete={() => {}} // No delete in outfit studio
                          onToggleFavorite={() => {}} // No favorite toggle in outfit studio
                        />
                      </div>
                    ))}
                  </div>
            ...
            // Friends' items - Show list format
