...
export default {
  ...
  async getHistory(filters = {}) {
    let query = supabase.from('outfit_history').select('*').order('worn_date', { ascending: false })
  ...
  async getHistoryEntry(id) {
    const { data, error } = await supabase.from('outfit_history').select('*').eq('id', id).single()
