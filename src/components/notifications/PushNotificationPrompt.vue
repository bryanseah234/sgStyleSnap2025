    ...
    <div class="p-4">
      <div class="space-y-3 mb-4">
        <div class="flex items-start space-x-3">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-300">Friend requests and acceptances</p>
        </div>
        <div class="flex items-start space-x-3">
          <svg class="w-5 h-5 text-green-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path
          ...
          <p class="text-sm text-gray-600 dark:text-gray-300">Likes and comments on your outfits</p>
        </div>
        <div class="flex items-start space-x-3">
          <svg class="w-5 h-5 text-green-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            <path
          ...
          <p class="text-sm text-gray-600 dark:text-gray-300">Outfit suggestions from friends</p>
        </div>
      </div>
