<template>
  <div class="style-preferences-editor">
    <!-- Header -->
    <div class="mb-6">
      <h2 class="text-2xl font-bold text-gray-900 mb-2">Style Preferences</h2>
      <p class="text-gray-600">Help us personalize your outfit suggestions by sharing your style preferences</p>
    </div>

    <!-- Loading State -->
    <div v-if="loading && !hasLoadedPreferences" class="text-center py-12">
    ...
    <form v-else @submit.prevent="handleSave" class="space-y-8">
      ...
      <section class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 mb-1">Favorite Colors</h3>
          <p class="text-sm text-gray-600">Select colors you love to wear</p>
        </div>
        <ColorPicker
      ...
      <section class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 mb-1">Colors to Avoid</h3>
          <p class="text-sm text-gray-600">Colors that don't suit your style or complexion</p>
        </div>
        <ColorPicker
      ...
      <section class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 mb-1">Preferred Styles</h3>
          <p class="text-sm text-gray-600">Choose up to 5 styles that match your aesthetic</p>
        </div>
        <StyleSelector
      ...
      <section class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 mb-1">Favorite Brands</h3>
          <p class="text-sm text-gray-600">Add brands you love (optional)</p>
        </div>

        <!-- Brand Tags -->
        <div v-if="preferences.preferred_brands.length > 0" class="flex flex-wrap gap-2 mb-3">
          <div
      ...
      <section class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 mb-1">Fit Preference</h3>
          <p class="text-sm text-gray-600">How do you prefer your clothes to fit?</p>
        </div>
      ...
      <section class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 mb-1">Common Occasions</h3>
          <p class="text-sm text-gray-600">What occasions do you typically dress for?</p>
        </div>
      ...
      <section v-if="feedbackStats.total > 0" class="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg shadow-sm p-6">
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 mb-1">Your Feedback History</h3>
          <p class="text-sm text-gray-600">Based on {{ feedbackStats.total }} outfit suggestions</p>
        </div>

        <div class="grid grid-cols-3 gap-4">
          <div class="text-center">
            <div class="text-3xl font-bold text-green-600">{{ feedbackStats.positive }}</div>
            <div class="text-sm text-gray-600 mt-1">Liked</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-red-600">{{ feedbackStats.negative }}</div>
            <div class="text-sm text-gray-600 mt-1">Disliked</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-blue-600">{{ positivePercentage }}%</div>
