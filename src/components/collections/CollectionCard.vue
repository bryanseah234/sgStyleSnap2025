<template>
  <div
    class="collection-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer group"
  >
    <!-- Collection Cover -->
    <div
    ...
    >
      ...
      <!-- Outfit Count Badge -->
      <div
        class="absolute top-2 right-2 bg-black bg-opacity-70 text-white px-2 py-1 rounded-full text-xs font-medium"
      >
      ...
      <!-- Visibility Badge -->
      <div
        class="absolute bottom-2 left-2 flex items-center space-x-1 bg-black bg-opacity-70 text-white px-2 py-1 rounded-full text-xs"
      >
        <svg
          class="w-3 h-3"
          fill="none"
    ...
    <div
      class="p-3 pt-0 flex items-center justify-end space-x-2 opacity-0 group-hover:opacity-100 transition-opacity"
    >
      <button
