<template>
  <div class="seasonal-breakdown">
    <div class="bg-white rounded-lg shadow-sm p-6">
      <!-- Header -->
      <div class="mb-6">
        <h3 class="text-lg font-semibold text-gray-900">Wardrobe Breakdown</h3>
        <p class="text-sm text-gray-600 mt-1">How you use your closet</p>
      </div>
      ...
      <div v-else class="space-y-6">
        ...
        <div v-if="weatherData" class="border-t pt-6">
          <h4 class="text-sm font-semibold text-gray-700 mb-3 flex items-center">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="p-3 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg">
              <div class="text-xs text-gray-600 mb-1">Avg Temperature</div>
            ...
            <div class="p-3 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-lg">
              <div class="text-xs text-gray-600 mb-1">Most Common</div>
