-- ============================================
-- Migration 033: Add Privacy to Outfits
-- ============================================
-- Purpose: Add privacy field to outfits table and update RLS policies to allow friends to view each other's items and outfits
-- Dependencies: 020_add_outfits_table.sql
-- Creates:
--   - Privacy indexes on outfits and clothes tables
-- Modifies:
--   - outfits table (adds privacy column)
--   - clothes table (updates privacy constraint)
--   - RLS policies for outfits, outfit_items, and clothes
-- 
