-- ============================================
-- Migration 029: Friend Request & Outfit Sharing Notifications
-- ============================================
-- Purpose: Adds notification support for friend requests and outfit sharing
-- Dependencies: 009_notifications_system.sql, 018_notification_cleanup_system.sql
-- Creates:
--   - outfit_shares table
--   - Notification functions for friend requests and outfit sharing
-- Modifies:
--   - notifications table (type constraint)
